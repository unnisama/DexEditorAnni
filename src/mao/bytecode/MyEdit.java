...
public class MyEdit extends EditText{
    ...
    public InputConnection onCreateInputConnection(EditorInfo edit){
        ...
        {
            public boolean commitCorrection(CorrectionInfo ko){
                return ic.commitCorrection(ko);
            }
           ...
           public Handler getHandler(){
            ...
            public boolean commitContent(InputContentInfo ici,int i, Bundle b){
                return ic.commitContent(ici, i, b);
            }
            public boolean deleteSurroundingTextInCodePoints(int p1, int p2){
                return ic.deleteSurroundingTextInCodePoints(p1,p2);
            }
            public CharSequence getSelectedText(int p1){
                return ic.getSelectedText(p1);
            }
            ...
            */
            public boolean requestCursorUpdates(int pd){
               return ic.requestCursorUpdates(pd);
            }

            public boolean setComposingRegion(int ko, int ko1){
                return ic.setComposingRegion(ko,ko1);
            }
        };
    }
